...
public class IQuestionnaireImpMockOkTest extends TestCase {

    private IQuestionnaire Iquestionnaire = new IQuestionnaireImplMockOk();
    public void chargerQuestionnaireTestOK(String url) throws FileNotAvailableException, EmptyFileException, CannotReadFileException {
        ...
        Assert.assertEquals(Iquestionnaire.chargerQuestionnaire("questionnaire_sme/src/test/resources/testOk"), questionnaire);
    }
/*
